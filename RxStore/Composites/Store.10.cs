...
namespace RxStore
{
        ...
        : Store<TState, TAction>
    {
        protected Store(
            ...
            Store<TState9, TAction9> store9,
            Func<TAction9, TAction> action9Generalizer,
            Store<TState10, TAction10> store10,
            Func<TAction10, TAction> action10Generalizer,
            Func<
                TState1,
                TState2,
                TState3,
        ...
        private delegate StateTransition StateTransitionGeneralizer(
            ...
            Store<TState9, TAction9>.StateTransition stateTransition9,
            Store<TState10, TAction10>.StateTransition stateTransition10,
            TState state
        );
        ...
        )
        {
            ...
            return Observable.Zip(
                Observable.Merge(
                    ...
                    store9.OutStateTransitions
                        .Skip(1)
                        .Select(next => (StateTransitionGeneralizer) For9),

                    store10.OutStateTransitions
                        .Skip(1)
                        .Select(next => (StateTransitionGeneralizer) For10),
                ...
                (func, tuple) => func(
                    ...
                    tuple.stateTransition9,
                    tuple.stateTransition10,
                    stateComposer(
                        ...
                        tuple.stateTransition9.State,
                        tuple.stateTransition10.State
                    )
                )
            );
            ...
            Store<TState, TAction>.StateTransition For9(
                Store<TState1, TAction1>.StateTransition stateTransition1,
                Store<TState2, TAction2>.StateTransition stateTransition2,
                Store<TState3, TAction3>.StateTransition stateTransition3,
                Store<TState4, TAction4>.StateTransition stateTransition4,
            ...
            {
                return stateTransition9 switch
                {
                    Store<TState9, TAction9>.StateTransition.ByAction byAction =>
                        StateTransition.NewByAction(state, action9Generalizer(byAction.Action)),
                    _ => throw new NotImplementedException()
                };
            }

            Store<TState, TAction>.StateTransition For10(
                Store<TState1, TAction1>.StateTransition stateTransition1,
                Store<TState2, TAction2>.StateTransition stateTransition2,
                Store<TState3, TAction3>.StateTransition stateTransition3,
                Store<TState4, TAction4>.StateTransition stateTransition4,
            ...
            {
                return stateTransition10 switch
                {
                    Store<TState10, TAction10>.StateTransition.ByAction byAction =>
                        StateTransition.NewByAction(state, action10Generalizer(byAction.Action)),
                    _ => throw new NotImplementedException()
                };
            }
        }
